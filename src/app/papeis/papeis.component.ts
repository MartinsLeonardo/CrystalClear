...
export class PapeisComponent implements OnInit {
  papeis = [
    ...
    new Papel('Coordinator (Cordenador)','Seu papel é o de cuidar de documentações como Mapa do Projeto, Plano de Liberação, Status do Projeto, Lista de Riscos, Plano de Iteração e Status, Cronograma de Visualização.','../../assets/img/papeis/coordinator.png'),
    ...
    new Papel('Tester (Papel Rotativo)','Bug Reports','../../assets/img/papeis/tester.png'),
    new Papel('Writer (Escritor - Papel Rotativo)','Responsável pelas revisões de textos, por redigir o texto de ajuda ao usuário.','../../assets/img/papeis/writer.png')
  ]
  constructor() { }
