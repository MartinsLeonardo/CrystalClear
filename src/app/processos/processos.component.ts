...
//  new Processo('4. Edição e Revisão','Reunião na qual o Patrocinador Executivo controlará as prioridades do projeto enquanto a equipe de desenvolvimento controlará a estimativa de quanto tempo cada tarefa levará.','yellow'),
//  5?????? Monitoramento
//  new Processo('6. Iteration Planning (Planejamento)','Reunião de prazo máximo de 1 hora para definir as seguintes situações: _Prioridades da iteração semanal. _Planejar como será o Desenvolver, Testar e Integrar.','blue'),
    //new Processo('6. Atividades Diárias/Semanais','Check-in diário (10 min), FeedBacks ao sistema de monitoramento, Episódio de Desenvolvimento, Contar com o feedback do Embassador User por menos de 1 hora por semana coloca o projeto em zona de risco em relação à adequação dos requisitos.','blue'),
//new Processo('7. Episódio de Desenvolvimento','Consiste na atividade de desenvolvimento do projeto, indica-se o uso de versionamento de códigos e estratégia de programação lado-a-lado.','blue'),
  // 8 ????????????
  //  new Processo('9. Workshop e Celebração','Oficinas pós interação são para auxílio emocional dos colaboradores e para discussão da saúde do projeto. Verifica-se ferramenta de monitoramento e com feedbacks ao grupo sobre o andamento do projeto.','blue'),
     //    new Processo('10. Entregas Para usuários finais','A primeira entrega na metodologia Crystal Clear tem prazo máximo de 3 meses para realizar-se contando do início do projeto, mas o indicado é que sejam realizadas entregas finais mensalmente. Conta com duas fases: Implantação e Treinamento.','yellow'),
